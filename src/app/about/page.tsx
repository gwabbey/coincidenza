...
export default async function About() {
    return (
        <div className="flex flex-col gap-4 max-w-4xl mx-auto text-center">
            ...
            <div>l'obiettivo di questo progetto è quello di fornire un'unica interfaccia semplice, moderna e veloce in
                cui pianificare
                i propri viaggi con i mezzi pubblici usando informazioni precise e aggiornate in tempo reale e
                raccogliendo più dati pubblici possibili.
            </div>
            <Alert className="p-4 text-center max-w-2xl mx-auto" hideIcon variant="faded" color="warning">
                Questo progetto è realizzato esclusivamente a scopo personale e didattico. Tutti i dati utilizzati sono
                reperiti da fonti pubblicamente accessibili online.
