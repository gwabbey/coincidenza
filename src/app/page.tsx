...
const links = [
    {
        href: "/bus",
        label: "partenze da una fermata",
        icon: IconBus,
        className: "bg-gradient-to-r dark:from-green-500 dark:to-blue-500 from-green-300 to-blue-300"
    },
    {
        href: "/departures",
        label: "partenze da una stazione",
        icon: IconTrain,
        className: "bg-gradient-to-r dark:from-red-500 dark:to-pink-500 from-red-300 to-pink-300"
    },
    {
        href: "/about",
        label: "info sul progetto",
        icon: IconInfoCircle,
        className: "bg-gradient-to-r dark:from-gray-500 dark:to-slate-500 from-gray-300 to-slate-300"
    },
]
...
export default async function Page() {
    ...
    return (
        <div className="flex flex-col items-center justify-start gap-4 text-center">
            ...
            {alerts.length > 0 &&
                <Card className="flex flex-col p-2 gap-2 max-w-2xl w-full rounded-large shadow-medium text-left">
                    <CardHeader className="text-xl font-bold pb-0">⚠️ avvisi sulla rete ferroviaria️</CardHeader>
