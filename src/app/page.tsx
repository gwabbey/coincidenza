...
const links = [
    ...
    { href: "/departures", label: "consulta i tabelloni delle partenze", icon: IconTrain },
]

export default function Page() {
    return (
        <div className="flex flex-col items-center justify-start gap-4 text-center">
            <h1 className="text-2xl font-bold">benvenut*</h1>
            ...
            {links.map((link, index) => (
                <Button variant="solid"
                    ...
                    key={index}
                    className="bg-gradient-to-r dark:from-violet-500 dark:to-indigo-500 from-violet-300 to-indigo-300 max-w-2xl w-full flex items-center justify-start h-16 font-bold text-2xl"
